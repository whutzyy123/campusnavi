...
export function BottomTabBar() {
  ...
  return (
    <nav
      className="fixed inset-x-0 bottom-0 z-[55] border-t border-gray-200 bg-white/95 backdrop-blur-md"
      style={{ paddingBottom: "env(safe-area-inset-bottom, 0px)" }}
      aria-label="底部主导航"
    >
      <div className="mx-auto grid h-16 max-w-2xl grid-cols-4 px-1">
        <Link
          href="/"
          className={`flex flex-col items-center justify-center gap-1 rounded-lg text-xs transition-colors ${
